 ...
 */
package org.opendaylight.periodictableparser.cli.commands;
...
public class PeriodictableparserCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(PeriodictableparserCliTestCommand.class);
    protected final PeriodictableparserCliCommands service;

    public PeriodictableparserCliTestCommand(final PeriodictableparserCliCommands service) {
